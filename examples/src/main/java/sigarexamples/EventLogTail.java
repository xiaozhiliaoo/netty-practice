...
package sigarexamples;

import org.hyperic.sigar.win32.*;

public class EventLogTail {

    private static void tail(String name, org.hyperic.sigar.cmd.Tail tail) throws Win32Exception {
    ...
    public static void main(String[] args) throws Exception {
        org.hyperic.sigar.cmd.Tail tail = new org.hyperic.sigar.cmd.Tail();
        tail.parseArgs(args);
